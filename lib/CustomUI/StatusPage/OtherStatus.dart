...
class OthersStatus extends StatelessWidget {
  const OthersStatus({super.key, required this.name, required this.time,required this.imageName, required this.isSeen, required this.statusNum});
   final String name;
   final String time;
...
class StatusPainter extends CustomPainter
{
  ...
  void paint(Canvas canvas, Size size) {
      ...
      ..isAntiAlias=true
      ..strokeWidth=6.0
      ..color= isSeen ? Colors.grey : Color(0xff21ba6)
